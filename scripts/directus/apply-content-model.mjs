...
const fields = {
  ...
  worship_services: [["name", "string", true], ["audience", "string", false], ["weekday", "string", false], ["weekdays", "json", false], ["start_time", "time", true], ["location", "string", false], ["description", "text", false], ["sort", "integer", true], ["status", "string", true]],
  stories: [["slug", "string", false], ["title", "string", true], ["subtitle", "text", false], ["summary", "text", false], ["category", "string", false], ["body", "json", true], ["cover_image_url", "string", false], ["cover_image", "uuid", false], ["cover_image_width", "integer", false], ["cover_image_height", "integer", false], ["cover_alt", "string", false], ["published_at", "timestamp", false], ["status", "string", true]],
  story_media: [["story", "integer", true], ["file", "string", true], ["alt", "string", false], ["caption", "string", false], ["sort", "integer", true]],
  sermons: [["slug", "string", false], ["title", "string", true], ["summary", "text", true], ["scripture", "string", true], ["preacher", "string", true], ["sermon_date", "date", true], ["video_url", "string", false], ["video_file", "uuid", false], ["status", "string", true]],
  bulletins: [["slug", "string", false], ["title", "string", true], ["category", "string", true], ["summary", "text", false], ["body", "text", false], ["document_image_url", "string", false], ["document_file", "uuid", false], ["document_image_width", "integer", false], ["document_image_height", "integer", false], ["document_alt", "string", false], ["published_at", "timestamp", false], ["status", "string", true]],
  bulletin_media: [["bulletin", "integer", true], ["file", "uuid", true], ["alt", "string", false], ["caption", "string", false], ["sort", "integer", true]],
  news_items: [["slug", "string", false], ["type", "string", false], ["title", "string", true], ["summary", "text", false], ["body", "json", false], ["event_starts_at", "timestamp", false], ["event_ends_at", "timestamp", false], ["location", "string", false], ["published_at", "timestamp", false], ["status", "string", true]],
};
