...
const fields = {
  ...
  stories: [["slug", "string", false], ["title", "string", true], ["subtitle", "text", false], ["summary", "text", false], ["category", "string", false], ["body", "text", true], ["cover_image_url", "string", false], ["cover_image", "uuid", false], ["cover_image_width", "integer", false], ["cover_image_height", "integer", false], ["cover_alt", "string", false], ["published_at", "timestamp", false], ["status", "string", true]],
  ...
  news_items: [["slug", "string", false], ["type", "string", false], ["title", "string", true], ["summary", "text", false], ["body", "text", false], ["event_starts_at", "timestamp", false], ["event_ends_at", "timestamp", false], ["location", "string", false], ["published_at", "timestamp", false], ["status", "string", true]],
};
