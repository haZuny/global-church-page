...
const models = {
  ...
  stories: ["교회 이야기", "공동체 활동과 사진 기록을 작성합니다.", { slug: "주소 이름", title: "제목", subtitle: "부제", summary: "목록 요약", category: "분류", body: "본문", cover_image_url: "대표 이미지 경로", cover_image_width: "이미지 너비", cover_image_height: "이미지 높이", cover_alt: "이미지 설명", published_at: "공개일", status: "게시 상태" }],
  ...
  bulletins: ["주보", "주보와 예배 자료를 관리합니다.", { slug: "주소 이름", title: "제목", category: "분류", summary: "목록 요약", document_image_url: "주보 이미지 경로", document_image_width: "이미지 너비", document_image_height: "이미지 높이", document_alt: "이미지 설명", published_at: "공개일", status: "게시 상태" }],
