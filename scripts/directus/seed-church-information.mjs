...
const church = {
  ...
  hero_copy: "믿음이 익숙하지 않아도 괜찮습니다. 시흥에서 함께 질문하고, 함께 자라갑니다.",
  introduction: "글로벌교회는 삶의 목적과 하나님의 뜻을 함께 고민하고, 각 사람 안에 주신 비전을 세워가는 공동체를 꿈꿉니다.",
  greeting_title: "글로벌교회를 찾아주신 여러분을 환영합니다.",
  greeting_lead: "교회가 익숙한 분도, 처음이라 조금 조심스러운 분도 편안히 머물 수 있기를 바랍니다.",
  greeting_body: "우리는 삶의 모든 답을 이미 가진 사람들이 아니라 말씀 앞에서 함께 질문하고, 서로의 이야기에 귀 기울이며, 하나님이 각 사람에게 주신 부르심을 발견해 가는 공동체입니다. 예배와 일상이 따로 떨어지지 않도록 배운 말씀을 삶의 자리에서 천천히 살아내고자 합니다.\n\n바로 등록하거나 무엇을 결정하지 않아도 괜찮습니다. 먼저 예배에 참여하고, 공동체의 모습을 살펴보고, 궁금한 점을 편하게 물어보세요. 여러분의 걸음을 재촉하지 않고 기쁘게 맞이하겠습니다.",
  pastor_name: "권오선",
