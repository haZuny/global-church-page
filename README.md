...
현재 저장소에는 기획 방향을 확인하기 위한 정적 다중 페이지 데모가 포함되어 있습니다. 별도 설치 없이 `index.html`을 브라우저에서 열거나 간단한 로컬 서버를 실행하면 됩니다.
...
교회명은 `글로벌교회(Global Community Church)`로 반영했습니다. 이야기와 주보에는 네이버 카페 및 부교역자 인스타그램의 공개 자료를 사용했고, 일부 콘셉트 이미지와 예배 시간·주소·연락처·설교 정보는 실제 운영 전에 교체해야 합니다.
...
- [글로벌교회 네이버 카페](https://cafe.naver.com/greenmccvf)
- [지유쓰 관련 공개 인스타그램](https://www.instagram.com/p/DYZQdyaE2JB/)
