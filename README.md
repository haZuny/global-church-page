...
| 상세 이동 | 이미지와 게시물 제목 모두 같은 이야기 상세 페이지로 연결합니다. 섹션 하단에는 교회 이야기 전체 목록으로 이동하는 링크 하나를 둡니다. |
...
| 상세 이동 | 이미지와 게시물 제목 모두 해당 주보·소식 상세 페이지로 연결합니다. 섹션 하단에는 주보·소식 전체 목록으로 이동하는 링크 하나를 둡니다. |
